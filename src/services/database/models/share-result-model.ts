...
const shareResultSchema = new Schema(
  {
...
export type ShareResultDocument = InferSchemaType<typeof shareResultSchema>;

export const ShareResultModel = models.ShareResult ?? model("ShareResult", shareResultSchema);